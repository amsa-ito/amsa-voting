...
class Amsa_Voting_Poll_Topics_Public {
    ...
    public static function render_partials($partial_path, $args = array(), $partials_root='poll_topics/') {
    ...
    public function render_proxy_nomination_list(){
        ...
        if (get_option('amsa_voting_event_registration_post_id')){
