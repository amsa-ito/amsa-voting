...
$button_text = ($poll_status === 'open') ? 'Close Ballot' : 'Open Ballot';
?>
    <p>This is visible to you because you have enough admin rights</p>
    <form id="admin-toggle-ballot-status"data-post_id="<?php echo esc_attr($post_id); ?>">
        <button type="button" id="ballot_status_change" name="poll_status_change" value=<?php echo $poll_status ?>><?php echo (esc_html($button_text))?></button>
    </form>