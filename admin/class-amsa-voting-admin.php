...
class Amsa_Voting_Admin {
	...
	public function __construct( $plugin_name, $version, $post_name ) {
		...
		$this->helper_register_post_meta('_voted_users', 'array', array()); #array(array('user_id'=>, 'vote_weight'=>, 'vote_value'=>))
		...
		register_meta('user', 'amso_voting_proxy', array(
			'type' => 'integer',
